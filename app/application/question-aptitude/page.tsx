    ...
    { field: "question7",  questionNum: 7,  description: (
        <div>
             <span className="text-pretty">
                ...
                <div className='flex flex-row [&>div]:mx-5 my-3'>
                    <div className='flex flex-col'>
                    <strong>หุ่นยนต์ A</strong><br />
                    Code name: สาส์นจากสวรรค์หุ่นยนต์ผู้ซึ่งปลดแอกจากการจองจำของปีศาจจากขุมนรก<br />
                    <img src="https://i.postimg.cc/L88RTbv4/Screenshot-2026-02-20-175750.png" className='mt-2 object-cover max-w h-[300px] rounded-md'></img>
                </div>
                <div className='flex flex-col'>
                    ...
                    <img src="https://i.postimg.cc/P5P9Ns29/Screenshot-2026-02-20-192144.png" className='mt-2 object-cover h-[300px] rounded-md'></img>
                </div></div>
