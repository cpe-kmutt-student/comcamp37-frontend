...
export default function Home() {
  ...
  return (
      ...
      >
          ...
          <div id={"about"} className="mt-35 pt-15 md:mt-50 md:pt-15">
              <AboutSection/>
          </div>
