...
export const FAQQuestions:faqsProps[] = [
    ...
    },
    {
        ...
        answer: "ไม่สามารถใช้แทนกันได้ค่ะ ใช้ได้เพียง ปพ.1 เท่านั้น\n" +
            "ม.5 ใช้เกรด 4 เทอมล่าสุด หากไม่ทัน ใช้ 3 เทอมได้\n" +
            "ม.4 ใช้เกรด 2 เทอมล่าสุด หากไม่ทัน ใช้ 1 เทอมได้",
    },
    {
        id: "5",
